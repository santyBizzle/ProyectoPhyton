...
import service.tipoDireccionService;
import service.tipoDireccionServiceImpl;
...
public class servletInit extends HttpServlet {
	...
	@Inject
	private personaService customerServicio;

	@Inject
	private tipoDireccionService orderServicio;

	public void init() {
		customerServicio = new personaServiceImpl();
		orderServicio = new tipoDireccionServiceImpl();
	}
